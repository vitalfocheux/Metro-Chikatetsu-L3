...
public class TestMetroSelenium {
    ...
    @Test
    public void sapporoSummerFestival(){
        /*String c = metro.addCharacter();
        metro.buyTicket(1, 0, 200, 200);
        metro.passBarrier(true, 1, true);
        metro.escalator();
...
class MetroAdapter {
     ...
     */
    public MetroAdapter() {
        System.setProperty("webdriver.chrome.driver", "C:/Users/vital/Downloads/chromedriver-win64/chromedriver-win64/chromedriver.exe");
    ...
    public void escalator(){
        driver.findElement(By.cssSelector(".escalator:nth-child(10)")).click();
        driver.findElement(By.cssSelector(".escalator:nth-child(10) > .down")).click();
        try {
            Thread.sleep(20000);
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
        driver.findElement(By.cssSelector(".wall")).click();
        try {
            Thread.sleep(6000);
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    public void line(String line, String station){
        String currentStation = driver.findElement(By.cssSelector(".panel h1 span")).getText();
        System.out.println(driver.findElement(By.cssSelector(".panel .line > div")).getText());
    }
